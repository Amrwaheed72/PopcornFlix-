...
export const { useGetMoviesQuery, useGetGenresQuery, useGetMovieQuery, useGetCreditsQuery, useGetRecommendationsQuery, useGetActorQuery, useGetMoviesByActorIdQuery } = tmdbApi;
